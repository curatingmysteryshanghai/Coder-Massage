...
$CodexDoctor = Join-Path $GameDir "scripts/codex-hook-doctor.mjs"
$CodexManifest = Join-Path $GameDir ".codex-plugin/plugin.json"
$Installed = $false
$CodexPending = $false
$DoctorExitCode = 0
...
if ($NodeMajor -lt 18) {
  throw "Jieya requires Node.js 18 or newer; found v$NodeVersion."
}
